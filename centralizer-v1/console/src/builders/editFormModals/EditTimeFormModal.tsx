...
interface EditTimeFormModalProps {
    fieldData: any,
    handleCloseEditTimeFormModal: any,
    showEditTimeFormModal: boolean,
    appSlug: string,
    slug: string,
    userRole: string,
    dataType: number
...
export function EditTimeFormModal(props: EditTimeFormModalProps) {
    ...
    async function onSubmit(data: any){
        ...
        function onSuccess() {
            ...
            setLoading(false);
            props.handleCloseEditTimeFormModal();
        }
    ...
    return (
        <>
            <Modal show={props.showEditTimeFormModal} onHide={props.handleCloseEditTimeFormModal} size={"lg"} centered>
