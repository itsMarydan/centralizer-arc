...
interface EditRichTextFormProps {
    showEditBooleanForm: boolean,
    handleCloseEditBooleanForm: any,
    fieldData: any,
    appSlug: string,
    slug: string,
    userRole: string,
...
export function EditBooleanFieldFormModal(props: EditRichTextFormProps) {
    ...
    async function onSubmit(data: any){
        ...
        function onSuccess() {
            ...
            setLoading(false);
            props.handleCloseEditBooleanForm();
        }
    ...
    return (
        <>
            <Modal show={props.showEditBooleanForm} onHide={props.handleCloseEditBooleanForm} size={"lg"} centered>
