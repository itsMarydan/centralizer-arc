...
interface EditRichTextFormProps {
    showEditRichTextForm: boolean,
    handleCloseEditRichTextForm: any,
    fieldData: any,
    appSlug: string,
    slug: string,
    userRole: string,
...
export function EditRichTextFieldModal( props: EditRichTextFormProps) {
    ...
    async function onSubmit(data: any){
        ...
        function onSuccess() {
            ...
            setLoading(false);
            props.handleCloseEditRichTextForm();
        }
    ...
    return (
        <>
            <Modal show={props.showEditRichTextForm} onHide={props.handleCloseEditRichTextForm} size={"lg"} centered>
