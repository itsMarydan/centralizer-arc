...
interface EditJsonFormProps {
    showEditJsonForm: boolean,
    handleCloseEditJsonForm: any,
    fieldData: any,
    appSlug: string,
    slug: string,
    userRole: string,
...
export function EditJsonFormModal(props: EditJsonFormProps) {
    ...
    return (
        <>
            <Modal show={props.showEditJsonForm} onHide={props.handleCloseEditJsonForm} size={"lg"} centered>
