...
interface EditDateFormModalProps{
    fieldData: any,
    handleCloseEditDateModalForm: any,
    showEditDateModalForm: boolean,
    appSlug: string,
    slug: string,
    userRole: string,
    dataType: number
}
export function EditDateFormModal(props: EditDateFormModalProps){
    const methods = useForm();
    const [loading, setLoading] = React.useState(false);
    const [errorMessage, setErrorMessage] = React.useState("");
    const dispatch = useAppDispatch();
    async function onSubmit(data: any){
        data.contentType = FieldTypeName.DATE;
        ...
        function onSuccess() {
            ...
            setLoading(false);
            props.handleCloseEditDateModalForm();
        }
    ...
    return (
        <>
        <Modal show={props.showEditDateModalForm} onHide={props.handleCloseEditDateModalForm} size={"lg"} centered>
