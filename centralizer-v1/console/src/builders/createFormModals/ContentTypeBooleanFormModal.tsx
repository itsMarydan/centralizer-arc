...
interface RichTextFormProps{
    showBooleanFormModal: boolean,
    handleCloseBooleanFormModal: any,
    appSlug: string,
    slug: string,
    userRole: string,
    dataType: number,
}
export function BooleanFiledFormModal(props: RichTextFormProps){
    ...
    async function onSubmit(data: any){
        setLoading(true)
        data.contentType = FieldTypeName.BOOLEAN;
        ...
        function onSuccess() {
            ...
            setLoading(false);
            props.handleCloseBooleanFormModal();
        }
    ...
    return (
        <>
            <Modal show={props.showBooleanFormModal} onHide={props.handleCloseBooleanFormModal} size={"lg"} centered>
                <Modal.Header  closeButton>Boolean Field</Modal.Header>
                <Modal.Body>
                    {errorMessage ?
