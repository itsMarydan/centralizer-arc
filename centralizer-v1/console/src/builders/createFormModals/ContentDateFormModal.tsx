...
export function DateFormModal(props: DateFormModalProps) {
    ...
    async function onSubmit(data: any){
        ...
        function onSuccess() {
            ...
            setLoading(false);
            props.handleCloseDateFormModal();
        }
    ...
    return (<Modal show={props.showDateModal} onHide={props.handleCloseDateFormModal} size="lg" centered>
            <Modal.Header closeButton>Date Field</Modal.Header>
            <Modal.Body>
                {errorMessage ?
