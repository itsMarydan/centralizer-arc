...
interface ContentDateTimeFormModalProps{

    handleCloseDateTimeFormModal: any,
...
export function ContentDateTimeFormModal(props : ContentDateTimeFormModalProps){
    ...
    async function onSubmit(data: any){
        ...
        function onSuccess() {
            ...
            setLoading(false);
            props.handleCloseDateTimeFormModal();
        }
    ...
    return (
        <>
            <Modal show={props.showDateTimeModal} onHide={props.handleCloseDateTimeFormModal}  size="lg"  centered>
                <Modal.Header closeButton>Date Time Field </Modal.Header>
                <Modal.Body>
                    {errorMessage ?
