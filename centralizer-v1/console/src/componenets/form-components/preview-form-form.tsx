...
export function PreviewFormForm(props : Props) {
    ...
    async function create(e: any) {
        ...
        await formsApi.createForm(props.appSlug, props.slug, props.userRole, inputs)
            .then((response: any) => {
                        ...
                        {props.builder.fields ?
                            <div className="form">
                                ...
                                <div className="my-3">
                                    {error ?
                                        <Alert
                                            message="Error On Form Submission"
                                            description={`Failed to submit form due to the following error : ${errorMessage}`}
                                            type="error"
                                            closable
