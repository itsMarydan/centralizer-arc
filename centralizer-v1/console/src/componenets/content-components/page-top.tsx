...
export function  PageTop(props: Props){
    ...
    return(
        <>
            ...
            <BuildModal appSlug={props.appSlug} userRole={props.userRole} slug={props.contentName} fields={props.builder.fields ? props.builder.fields : null } show={showBuild} handleClose={handleClose} dataType={DATA_TYPE.content}/>
        </>
    )
}